    ...
    <aside id="nsofts_sidebar">
        <nav class="nsofts-sidebar-nav" data-scroll="true">
            <ul>
                ...
                <li class="nsofts-sidebar-nav__item">
                    <a href="manage_audio.php" class="nsofts-sidebar-nav__link <?php if ($currentFile == "manage_audio.php" or $currentFile == "create_audio.php" or $currentFile == "edit_audio.php") { ?>active<?php } ?>">
                ...
                <?php if(isset($_SESSION['admin_type'])){?>
                    <?php if($_SESSION['admin_type'] != 0){?>
                        ...
                        <li class="nsofts-sidebar-nav__item nsofts-has-menu">
                            <a href="javascript:void(0)" class="nsofts-sidebar-nav__link <?php if ($currentFile == "settings_app.php" or $currentFile == "settings_web.php" or $currentFile == "settings.php"  or $currentFile == "settings_ads.php") { ?>open active<?php } ?>">
                                <i class="ri-settings-line nsofts-sidebar-nav__icon"></i>
                                <span class="nsofts-sidebar-nav__text">Settings</span>
                            </a>
                            <ul class="nsofts-submenu <?php if ($currentFile == "settings_app.php" or $currentFile == "settings_web.php" or $currentFile == "settings.php"  or $currentFile == "settings_ads.php") { ?>show<?php } ?>">
                                <li>
