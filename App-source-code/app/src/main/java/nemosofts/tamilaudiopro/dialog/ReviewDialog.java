...
import nemosofts.tamilaudiopro.executor.GetRating;
import nemosofts.tamilaudiopro.executor.LoadRating;
...
public class ReviewDialog {
                ...
                new GetRating(new RatingListener() {
                    ...
                    public void onEnd(String success, String rateSuccess, String message, int rating) {
                        ...
                        if (rating > 0) {
                            ...
                            tvRate.setText(ctx.getString(R.string.thanks_for_rating));
    ...
    private void loadRatingApi(final String rate, final String report, String id) {
        ...
        }, helper.getAPIRequest(Method.METHOD_RATINGS, 0, id,"","",report,
                spHelper.getUserId(),"","","","","",rate,
                "",null));
        loadRating.execute();
    }
    ...
    public interface RatingDialogListener {
        ...
        void onDismiss(String success, String rateSuccess, String message, int rating,
