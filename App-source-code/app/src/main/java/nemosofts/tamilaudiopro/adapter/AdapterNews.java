...
public class AdapterNews extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<ItemNews> arrayList;
    ...
    private static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private MyViewHolder(View view) {
            ...
            linearLayout = itemView.findViewById(R.id.ll_news);
            poster =  itemView.findViewById(R.id.iv_image_news);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder myViewHolder) {
            ...
            myViewHolder.title.setText(itemNews.getNewsName());
            myViewHolder.subTitle.setText(itemNews.getNewsName());

            int[] colors = {
                    R.color.purple_inactive, // step 1
                    R.color.blue_inactive, // step 2
                    R.color.green_inactive, // step 3
                    R.color.blue_grey_inactive, // step 4
                    R.color.red_inactive, // step 5
            };

            int step = (position % 5); // 0-based index
            myViewHolder.poster.setImageResource(colors[step]);

            myViewHolder.linearLayout.setOnClickListener(v -> listener.onClickListener(itemNews, holder.getAbsoluteAdapterPosition()));
                            ...
                            nativeAd.loadAd(new NativeAdPreferences()
                                ...
                                public void onReceiveAd(@NonNull Ad ad) {
                                    try {
                                        ...
                                        Log.e("AdapterNews", "onReceiveAd",e);
                                    }
                                }
    ...
    public void hideHeader() {
        try {
            ...
            Log.e("AdapterNews", "hideHeader", e);
        }
    }
    ...
    public interface RecyclerItemClickListener{
        void onClickListener(ItemNews itemNews, int position);
    }

    public void addAds(List<com.google.android.gms.ads.nativead.NativeAd> arrayListNativeAds) {
        isAdLoaded = true;
