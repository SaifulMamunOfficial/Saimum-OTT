...
public class AdapterAlbums extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterAlbums(Context context, List<ItemAlbums> arrayList, Boolean isOnline) {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            ...
            totalSongs = view.findViewById(R.id.tv_home_album_sub);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_PROG) {
            ...
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.layout_albums_normal, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder myViewHolder) {
            ...
            myViewHolder.imageView.setLayoutParams(new ConstraintLayout.LayoutParams(columnWidth, columnWidth));
            myViewHolder.title.setText(arrayList.get(holder.getAbsoluteAdapterPosition()).getName());
            myViewHolder.totalSongs.setText(arrayList.get(holder.getAbsoluteAdapterPosition()).getTotalSongs().concat(" ").concat(context.getString(R.string.songs)));
            ...
            myViewHolder.title.setTypeface(myViewHolder.title.getTypeface(), Typeface.BOLD);
            if (Boolean.FALSE.equals(isOnline)) {
                myViewHolder.totalSongs.setVisibility(View.VISIBLE);
                myViewHolder.totalSongs.setText(arrayList.get(holder.getAbsoluteAdapterPosition()).getTotalSongs());
            }
            ...
            if (adViewHolder.nativeAd.getChildCount() == 0) {
                switch (Callback.getAdNetwork()) {
                    ...
                    default -> adViewHolder.isAdRequested = false;
                }
            }
        } else {
            if (getItemCount() <= 10) {
