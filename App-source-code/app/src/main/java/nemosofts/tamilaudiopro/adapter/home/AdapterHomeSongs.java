...
public class AdapterHomeSongs extends RecyclerView.Adapter<AdapterHomeSongs.MyViewHolder> {
    ...
    public AdapterHomeSongs(Context context,
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_recent_audio, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.catTitle.setText(arrayList.get(position).getArtist());
    ...
    private void handleDownloadClick(BottomSheetDialog dialog, int pos) {
        if (DownloadService.count >= 0 && DownloadService.count < 5) {
            try{
                ...
                Log.e("AdapterHomeSongs", "Error handleDownloadClick", e);
            }
        } else {
