...
public class FragmentCategories extends Fragment {
    ...
    private void addOnScrollListener(GridLayoutManager manager) {
        ...
        if (helper.canLoadNativeAds(requireContext(),Callback.PAGE_NATIVE_CAT)
            ...
            adLoader = builder.forNativeAd(nativeAd -> {
                try {
                    ...
                    if (!adLoader.isLoading() && adapterCat != null) {
                        adapterCat.addAds(arrayListNativeAds);
                    }
                } catch (Exception e) {
