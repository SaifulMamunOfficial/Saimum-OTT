...
public class FragmentSearchArtist extends Fragment {
    ...
    private static final String TAG = "FragmentSearchArtist";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(((MainActivity) requireActivity()).getSupportActionBar()).setTitle(getString(R.string.search_artist));
    ...
    private void loadArtist() {
        ...
        }, helper.getAPIRequest(Method.METHOD_ARTIST, page, "", "",
                Callback.getSearchItem(), "","", "", "",
                "","","","","search", null));
        loadArtist.execute();
    }

    private void loadArtistEnd(String verifyStatus, String message,
    ...
    private void setAdapter() {
        if (Boolean.FALSE.equals(isScroll)) {
            adapter = new AdapterArtist(getActivity(), arrayList);
    ...
    public void setEmpty() {
        if (!arrayList.isEmpty()) {
            ...
            myView.findViewById(R.id.ll_empty_try).setOnClickListener(v -> loadArtist());
