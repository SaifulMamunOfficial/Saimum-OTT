...
import nemosofts.tamilaudiopro.activity.LauncherActivity;
import nemosofts.tamilaudiopro.activity.MainActivity;
import nemosofts.tamilaudiopro.callback.Callback;
import nemosofts.tamilaudiopro.interfaces.OnShowAdCompleteListener;
...
public class AppOpenAdManager {
    ...
    public boolean isAdAvailable() {
        switch (Callback.getAdNetwork()) {
            ...
            case Callback.AD_TYPE_WORTISE -> {
                return mAppOpenAdWortise != null && mAppOpenAdWortise.isAvailable() && wasLoadTimeLessThanNHoursAgo();
            }
            case Callback.AD_TYPE_APPLOVIN -> {
