<?php $page_title="Manage Reports";
    ...
    if(!isset($_GET['keyword'])){
        ...
        $sql_query="SELECT * FROM tbl_reports WHERE (`report_title` LIKE '%$keyword%') ORDER BY tbl_reports.`id` DESC"; 
    }
                    ...
                    <div class="row g-4">
                        <table class="table ">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th class="display-desktop">Post title</th>
                                    <th>Report</th>
                            ...
                            <tbody id="load-more-container">
                                <?php $i=0; while($row=mysqli_fetch_array($result)) { ?>
                                    <tr class="card-item">
                                        ...
                                        <td class="display-desktop"><?php echo $row['report_title'];?></td>
                                        <td class="text-truncate"><?php echo $row['report_msg'];?></td>
