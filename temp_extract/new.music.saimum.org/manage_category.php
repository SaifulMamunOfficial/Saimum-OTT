<?php $page_title="Manage Categories";
    ...
    if(!isset($_GET['keyword'])){
        $sql_query="SELECT * FROM tbl_category ORDER BY tbl_category.`cid` DESC"; 
    } else {
        $keyword=addslashes(trim($_GET['keyword']));
        $sql_query="SELECT * FROM tbl_category WHERE `category_name` LIKE '%$keyword%' ORDER BY tbl_category.`cid` DESC"; 
    }
                            ...
                            <div class="col-lg-3 col-sm-6 card-item">
                                <div class="nsofts-image-card">
                                    <div class="nsofts-image-card__cover mb-0">
                                        ...
                                        <img src="images/<?=$row['category_image']?>" onerror="this.src='assets/images/300x300.jpg';"  loading="lazy"  alt="">
                                    </div>
