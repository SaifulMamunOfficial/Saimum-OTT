                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="nsofts_setting_content_1" role="tabpanel" aria-labelledby="nsofts_setting_1" tabindex="0">
                                <form action="" name="settings_general" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                       <a style="color: #f44336c7;" href="https://1.envato.market/0Z0WKE" target="_blank">Tamilaudiopro - Online Music Streaming Website</a>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="nsofts-input-icon nsofts-input-icon--left">
                                                ...
                                                <input type="text" name="android_app_url" id="android_app_url" value="<?= $settings_data['android_app_url']?>"  class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
