                        ...
                        <form action="" name="addeditbanner" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="banner_post_id[]" id="banner_post_id" class="nsofts-select" multiple="multiple">
                                            ...
                                            <?php while($audio_row=mysqli_fetch_array($audio_result)){ ?> 
        										<option value="<?php echo $audio_row['id'];?>" <?php if(in_array($audio_row['id'], explode(",",$row['banner_post_id']))){?>selected<?php }?>><?php echo $audio_row['audio_title'];?></option>                           
        									<?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3 row">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control-file" name="banner_image"   accept=".png, .jpg, .JPG .PNG" onchange="fileValidation()" id="fileupload" <?php if(!isset($_GET['cat_id'])){?>required<?php } ?>>
                                    </div>
                                </div>
                            </div>
