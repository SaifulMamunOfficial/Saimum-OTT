<?php 
    ...
    if(isset($_POST['submit']) and isset($_GET['add'])){
        ...
        header( "Location:create_audio.php?add=yes");
        exit;
    }
?>
        ...
        <form action="" name="addeditaudio" method="POST" enctype="multipart/form-data">
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="card h-100">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                <input type="text" name="audio_title" id="audio_title" class="form-control" placeholder="Enter Audio Title" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="audio_description" id="audio_description" rows="5" class="nsofts-editor"></textarea>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card h-100">
                        <div class="card-body p-4">
                            <h5 class="mb-4">Upload Audio & Image</h5>
                            ...
                            <div id="audio_url_display" class="mb-3">
                                <input type="text" name="audio_url" id="audio_url" class="form-control" placeholder="Normal Quality Audio URL">
                            </div>
                            
                            <div id="audio_url_display_high" class="mb-3">
                                <input type="text" name="audio_url_high" id="audio_url_high" class="form-control" placeholder="High Quality Audio URL">
                            </div>
                            
                            <div id="audio_url_display_low" class="mb-3">
                                <input type="text" name="audio_url_low" id="audio_url_low" class="form-control" placeholder="Low Quality Audio URL">
                            </div>
                            
                            <div id="audio_local_display"  style="display:none;" class="mb-3">
                                ...
                                <div id="audio_player" class="nemosofts-player" style="display: none;">
