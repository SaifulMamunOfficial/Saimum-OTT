    ...
    <footer id="nsofts_footer">
        <div class="nsofts-container d-sm-flex justify-content-between text-center">
            <span>Copyright &copy; <?php echo date('Y'); ?> <a target="_blank" href="https://saimum.org"><span class="fw-semibold">Saimum Shilpigosthi</a> All rights reserved.</span></span>
            <div class="d-flex justify-content-center mt-2 mt-sm-0">
                <a href="https://youtube.com/@SaimumShilpigosthi" class="me-3" target="_blank">YouTube</a>
                <a href="https://t.me/SaimumShilpigosthi" class="me-3" target="_blank">Telegram</a>
            </div>
        </div>
    </footer>
    <!-- End: footer -->
