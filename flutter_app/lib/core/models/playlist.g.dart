...
PlaylistModel _playlistModelDeserialize(
  ...
  object.cloudId = reader.readLongOrNull(offsets[0]);
...
extension PlaylistModelQueryWhereSort
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterWhere> anyCloudId() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistModelQueryWhere
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterWhereClause> cloudIdEqualTo(
      int? cloudId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'cloudId',
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterWhereClause> cloudIdLessThan(
    int? cloudId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterWhereClause> cloudIdBetween(
    int? lowerCloudId,
    int? upperCloudId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlaylistModelQuerySortBy
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> sortByCloudId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cloudId', Sort.asc);
    });
  }

  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> sortByCloudIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> sortByImageUrl() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> sortByIsSynced() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistModelQuerySortThenBy
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> thenByCloudId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cloudId', Sort.asc);
    });
  }

  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> thenByCloudIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'cloudId', Sort.desc);
    });
  }
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> thenByImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageUrl', Sort.asc);
    });
  }
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QAfterSortBy> thenByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }
...
extension PlaylistModelQueryWhereDistinct
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QDistinct> distinctByCloudId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'cloudId');
    });
  }
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QDistinct> distinctByImageUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, PlaylistModel, QDistinct> distinctByIsSynced() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistModelQueryProperty
  ...
  QueryBuilder<PlaylistModel, int?, QQueryOperations> cloudIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlaylistModel, String?, QQueryOperations> imageUrlProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'imageUrl');
    });
  }

  QueryBuilder<PlaylistModel, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
